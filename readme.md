# SASS ROUTER CONTEXT MATERIALUI TEMPLATE
...
- MaterialUI React Component Library Installed, example of its use in the header component, refer to MaterialUI documentation for its use.
